...
<body background="cms.jpg" style=" background-repeat:no-repeat;background-size: 1420px 700px;">  
	<!-- <img src="E:\ProjectEnd\canteen\WebContent\canteenadmin.jpg"/> -->
<!-- <img alt="not found" src="/canteen/WebContent/canteenadmin.jpg"> -->
<div class="topnav">
  <a class="active" href="Home.jsp">Home</a>
  <a href="adminl.jsp">Admin</a>
                        ...
                        <div class="col-xs-12 col-sm-6 dis-table-cell">
                            <div class="section-content">
                                ...
                                <p class="section-content-para">
                                  Company Employee Canteen brings you a variety of dishes from different regions of India. You can enjoy the warmth of Indian hospitality and a variety of beverages. It is not just a place to eat and drink, but to have fun and relax. It is our commitment to use fresh ingredients. We do not use any preservatives or food color. 
                                <p class="section-content-para">
